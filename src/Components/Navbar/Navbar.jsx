  ...
  return (
    <nav className="bg-gradient-to-r from-black to-transparent px-2 sm:px-4 py-2.5">
      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="mr-auto ml-8 hidden w-full sm:block sm:w-auto">
          <button onClick={() => setFormOpen(true)} type="button" className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br hover:text-gray-800 focus:text-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create Event</button>
        </div>
